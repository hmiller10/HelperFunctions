...
Install-Module -Name Microsoft.PowerShell.PSResourceGet -Repository PSGallery -Scope AllUsers -TrustRepository -AcceptLicense -SkipDependencyCheck -PassThru -Confirm:$false
